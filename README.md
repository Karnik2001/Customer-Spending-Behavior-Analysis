...
Build and evaluate multiple classification models to predict customer behavior.
...
Model Training & Evaluation – Implementing multiple classifiers and tuning parameters.
...
Add customer segmentation using unsupervised clustering.
